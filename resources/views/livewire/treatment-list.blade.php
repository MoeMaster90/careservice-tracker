...
<ul class="font-medium text-gray-900 bg-white border-t border-l border-r border-gray-200 ">
    ...
    @foreach($treatments as $key => $treatment)
        ...
        <div class="flex items-center pl-3">
            <input id="bordered-checkbox-{{ $key }}" type="checkbox" value="{{ $treatment['name'] }}" name="bordered-checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" wire:model.defer="selectedTreatments">
